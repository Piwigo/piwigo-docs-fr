...
<aside>
ℹ️ Lire aussi : [Importer des photos dans Piwigo](../Importer et gérer les photos/Importer des photos dans Piwigo.md)
...
Vous pouvez télécharger des vidéos sur votre Piwigo en utilisant le plugin VideoJS et en ajoutant du code à votre configuration locale [(comme expliqué ici).](../Importer et gérer les photos/Les différents formats de fichiers.md)
...
Vous pouvez télécharger des fichiers PDF sur Piwigo, [comme expliqué ici](../Importer et gérer les photos/Les différents formats de fichiers.md).
