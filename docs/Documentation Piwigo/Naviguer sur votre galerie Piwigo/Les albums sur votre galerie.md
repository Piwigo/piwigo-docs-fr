...
[Organiser les albums](../Organiser les albums.md)
...
- Tous les albums privés que vous avez le droit de voir, si vous êtes connecté. [En savoir plus sur les permissions](../Organiser les albums/Permissions et visibilité des albums.md)
...
<aside>
ℹ️ Pour comprendre les notions d’albums et sous-albums, [lisez cet article](../Organiser les albums/Albums et sous-albums présentation.md). Il est possible qu’un album contienne à la fois des sous-albums et des fichiers, mais on le déconseille.
...
<aside>
ℹ️ Pour modifier le nombre de photos affichées sur une page album, rendez vous dans vos [préférences utilisateur](../Les utilisateurs/Créer et gérer les utilisateurs.md) ; vous pouvez y accéder en cliquant sur le menu “Personnaliser” sur la galerie, ou en modifiant votre profil utilisateur dans l’administration.
...
<aside>
ℹ️ Remarque : Les icônes et fonctionnalités disponibles sur votre galerie dépendent du thème que vous avez choisi, de la configuration de Piwigo, des plugins activés... Les exemples présentés sur cette page présentent les possibilités par défaut du thème [Modus](../Les thèmes/Le thème Modus.md). Si vous utilisez le thème [Bootstrap Darkroom](../Les thèmes/Le thème Bootstrap Darkroom.md), par exemple, les fonctionnalités disponibles sont globalement les mêmes, mais les icônes sont légèrement différentes.
...
Si vous êtes administrateur, l’icône représentant un chariot permet d’ajouter toutes les photos de l’album à votre panier. Vous retrouverez ensuite ce panier dans l’administration, et pourrez agir sur ces photos, via le [gestionnaire de lots](../Importer et gérer les photos/Gestion par lot Modifier et gérer une sélection de.md).

### Éditer l’album (administrateurs uniquement)

Si vous êtes administrateur, l’icône représentant un outil permet de vous rendre dans l’administration pour [modifier l’album](../Organiser les albums/Modifier un album.md).
...
- [Documentation de Modus](../Les thèmes/Le thème Modus.md)
- [Documentation de Bootstrap Darkroom](../Les thèmes/Le thème Bootstrap Darkroom.md)
...
Par défaut, Piwigo permet aux visiteurs de votre galerie de publier des [commentaires](../Les commentaires et notes/Personnaliser la gestion des commentaires avec des.md) sur les photos, mais pas sur les albums.

Si vous souhaitez activer cette option, il suffit d’activer le plugin **Comments on albums**.

[En savoir plus](../Les commentaires et notes/Personnaliser la gestion des commentaires avec des.md)
...
Vous pouvez les modifier grâce à [Localfile Editor](../Hébergez votre Piwigo/Modifier la configuration locale avec LocalFiles E.md) si vous travaillez sur un Piwigo auto-hébergé ; si vous êtes clients d’une offre piwigo.com, contactez le support pour modifier l’un de ces paramètres.
...
[Votre galerie : présentation](Votre galerie présentation.md)

Suivant →

[La page Photo sur votre galerie](La page Photo sur votre galerie.md)