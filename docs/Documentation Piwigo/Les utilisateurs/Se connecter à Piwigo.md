...
[En savoir plus](../Personnaliser ma galerie/Personnaliser votre galerie avec des plugins/PWG Stuffs ajouter des blocs sur votre galerie.md)
...
Pour savoir comment créer un utilisateur dans l’administration, [lisez cet article](Créer et gérer les utilisateurs.md).
...
<aside>
ℹ️ Pour en savoir plus sur la possibilité pour les utilisateurs de créer leur propre compte sur Piwigo, [lisez cet article](Créer et gérer les utilisateurs.md).
...
<aside>
ℹ️ Si vous souhaitez ajouter des champs personnalisés au formulaire de création de compte, vous devez activer le plugin User Custom Fields. [En savoir plus](Créer et gérer les utilisateurs.md)

</aside>

<aside>
ℹ️ Si vous souhaitez éviter la création de faux utilisateurs par des robots, vous pouvez contrôler la création de compte grâce à la saisie d’un Captcha. Pour cela, il faut activer le plugin **Crypto Captcha**. [En savoir plus](Créer et gérer les utilisateurs.md)

</aside>

Les comptes utilisateurs créés par via la galerie en autonomie ne sont pas administrateurs mais seulement Visiteurs. Pour en savoir plus sur les statuts utilisateurs, [lisez cet article](Les statuts utilisateurs.md).
...
[**Two Factor Authentication : activez la double authentification sur Piwigo**](Se connecter à Piwigo/Two Factor Authentication activez la double authen.md)
...
[Utilisateurs : présentation](Utilisateurs présentation.md)
