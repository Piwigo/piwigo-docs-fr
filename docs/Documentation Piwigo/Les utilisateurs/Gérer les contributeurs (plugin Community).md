...
- Un groupe d’utilisateur en particulier : vous pouvez créer un groupe Contributeurs, ce qui est le plus pratique. [En savoir plus sur les groupes d’utilisateurs](Les groupes d’utilisateurs.md)
...
[En savoir plus](../Personnaliser ma galerie/Personnaliser le menu de votre galerie.md)
...
[Les groupes d’utilisateurs](Les groupes d’utilisateurs.md)
