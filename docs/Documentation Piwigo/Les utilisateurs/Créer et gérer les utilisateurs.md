...
- email
- statut ([en savoir plus sur les statuts](Les statuts utilisateurs.md))
- niveau de confidentialité ([en savoir plus sur les niveaux de confidentialité](Les niveaux de confidentialité.md))
- groupe(s) ([en savoir plus sur les groupes d’utilisateurs](Les groupes d’utilisateurs.md))
- autorisation ou pas de télécharger des fichiers sur la galerie

Par défaut, les nouveaux utilisateurs héritent des mêmes préférences que l’utilisateur “Invité” (dont on parle [un peu plus tard](Créer et gérer les utilisateurs.md) dans cette page).
...
Pour en savoir plus sur les permissions sur les albums, [lisez cet article](../Organiser les albums/Permissions et visibilité des albums.md).
...
<aside>
ℹ️ Si l’utilisateur est membre d’un groupe, les permissions individuelles supplantent celle du groupe. [En savoir plus sur les groupes d’utilisateurs](Les groupes d’utilisateurs.md)
...
- celui qui a créé le compte, si vous utilisez un compte sur piwigo.com.
...
Pour en savoir plus sur le rôle et les droits associés à chaque Statut, [lisez cet article](Les statuts utilisateurs.md).
...
[En savoir plus sur les niveaux de confidentialité](Les niveaux de confidentialité.md)
...
[En savoir plus sur les groupes d’utilisateurs](Les groupes d’utilisateurs.md)
...
Vous pouvez enfin modifier en masse les préférences d’une liste d’utilisateurs en utilisant le mode Sélection (voir chapitre [Modifier des utilisateurs en masse](Créer et gérer les utilisateurs.md)).

Pour modifier les préférences appliquées par défaut aux nouveaux utilisateurs, il faut modifier le profil “invité ([voir plus loin](Créer et gérer les utilisateurs.md)).
...
[En savoir plus sur les langues](../Personnaliser ma galerie/Gérer les langues disponibles sur votre galerie.md)
...
[En savoir plus sur l’historique des visites](../Administrer Piwigo/Consultez les statistiques de votre Piwigo.md)
...
[En savoir plus sur l’historique des activités](../Administrer Piwigo/Consultez les statistiques de votre Piwigo.md)
...
Vous pouvez ensuite modifier ces utilisateurs en masse grâce au mode sélection (voir chapitre : [Modifier des utilisateurs en masse](Créer et gérer les utilisateurs.md))**.**
...
[Les statuts utilisateurs](Les statuts utilisateurs.md)

Suivant →

[Les niveaux de confidentialité](Les niveaux de confidentialité.md)