...
- J’héberge moi-même ma galerie (ou mon organisation le fait)
    ...
    Pour activer cette option, vous devez utilisez [LocalFile Editor](../Hébergez votre Piwigo/Modifier la configuration locale avec LocalFiles E.md) et ajouter le code ci-dessous dans votre fichier de configuration. Si vous n’en avez pas la possibilité, faites la demande au webmaster qui gère votre galerie.
...
[Gérez les propriétés et métadonnées de vos fichiers](Gérez les propriétés et métadonnées de vos fichier.md)