...
Pour en savoir plus sur l’import de photo, [lisez cet article](../Importer et gérer les photos/Importer des photos dans Piwigo.md).
...
[En savoir plus sur l’édition de photos](../Importer et gérer les photos/Modifier ou supprimer une photo.md)
...
Vous pouvez le faire facilement en passant par la [Gestion par Lot.](../Importer et gérer les photos/Gestion par lot Modifier et gérer une sélection de.md)
...
[Les tags : présentation](Les tags présentation.md)

Suivant →

[Tag Recognition : Taguez automatiquement vos photos par IA](Tag Recognition Taguez automatiquement vos photos.md)