...
- Gérer les photos de l’album : cette icône vous permet de modifier en lot les photos de votre album. [En savoir plus sur la gestion par lot](../Importer et gérer les photos/Gestion par lot Modifier et gérer une sélection de.md)
...
[Permissions et visibilité des albums](Permissions et visibilité des albums.md)
