...
<aside>
ℹ️ Lorsque vous créez un nouvel album à la racine de Piwigo, il est toujours public, par défaut. Si vous souhaitez modifier ce comportement, contactez le support si vous êtes client piwigo.com. Sinon, ajouter le paramètre suivant à votre configuration grâce à [LocalFiles Editor](../Hébergez votre Piwigo/Modifier la configuration locale avec LocalFiles E.md) : `$conf['newcat_default_status'] = 'private';`
...
[En savoir plus sur la modification des albums](Modifier un album.md)
...
Pour en savoir plus sur les groupes d’utilisateurs, [lisez cet article](../Les utilisateurs/Les groupes d’utilisateurs.md).
...
<aside>
ℹ️ Si vous voulez que les sous-albums héritent automatiquement des permissions de leurs parents, contactez le support si vous êtes client piwigo.com.  Sinon, ajoutez le paramètre suivant à votre configuration grâce à [LocalFiles Editor](../Hébergez votre Piwigo/Modifier la configuration locale avec LocalFiles E.md) : `$conf['inheritance_by_default'];`
...
Pour en savoir plus sur les commentaires, [lisez cet article](../Les commentaires et notes/Gérer les commentaires.md).
...
[Modifier un album](Modifier un album.md)
