...
- Si nécessaire, ajoutez un contrôle antispam sur les commentaires (pour en savoir plus, visitez la page [Commentaires : options avancées](Personnaliser la gestion des commentaires avec des.md))
...
[Personnaliser la gestion des commentaires avec des plugins](Personnaliser la gestion des commentaires avec des.md)