...
Dans l’article [Gérer les commentaires](Gérer les commentaires.md), nous présentons les options de base dans Piwigo sur la gestion des commentaires. Mais il existe plusieurs plugins permettant d’aller plus loin : on fait le tour de ces options dans cet article.
...
[Gérer les commentaires](Gérer les commentaires.md)