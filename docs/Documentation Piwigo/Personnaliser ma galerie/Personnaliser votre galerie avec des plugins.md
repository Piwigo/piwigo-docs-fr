...
[PWG Stuffs : ajouter des blocs sur votre galerie](Personnaliser votre galerie avec des plugins/PWG Stuffs ajouter des blocs sur votre galerie.md)
...
Le plugin Extended Description offre de nombreuses possibilités. Il est notamment utilisé pour traduire en plusieurs langues les titres et descriptions des albums et des photos [comme expliqué dans cet article](Gérer les langues disponibles sur votre galerie.md).
...
[Ajouter des pages à votre galerie](Ajouter des pages à votre galerie.md)
