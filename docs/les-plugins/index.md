...
[Les plugins sur Piwigo : présentation](les-plugins-sur-piwigo-presentation)
...
- [Créer des collections avec le plugin User Collections](../naviguer-sur-votre-galerie-piwigo/creer-des-collections-plugin-user-collections)
