...
Si vous êtes un client Piwigo Cloud, vous devez contacter le support.
...
Si vous êtes un client Piwigo Cloud, vous devez contacter le support pour le faire.
...
[Métadonnées EXIF et IPTC pour utilisateurs avancés](gerez-les-proprietes-et-metadonnees-de-vos-fichiers/mtadonnes-exif-et-iptc-pour-utilisateurs-avancs)
