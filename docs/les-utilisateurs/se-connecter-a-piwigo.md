...
Pour savoir comment créer un utilisateur dans l’administration, [lisez cet article](/les-utilisateurs/creer-et-gerer-les-utilisateurs).
...
[**Two Factor Authentication : activez la double authentification sur Piwigo**](/les-utilisateurs/se-connecter-a-piwigo/two-factor-authentication-activez-la-double-authentification-sur-piwigo)
...
[Utilisateurs : présentation](/les-utilisateurs/utilisateurs-presentation)
